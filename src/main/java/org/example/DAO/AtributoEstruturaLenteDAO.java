...
public class AtributoEstruturaLenteDAO extends ConexaoDB{
    ...
    public void insertAtributoEstruturaLente(AtributoEstruturaLente entity) {
        try (PreparedStatement preparedStatement = prepararSQL(INSERT_ATRIBUTO_ESTRUTURA_LENTE)) {
    ...
    public void deleteAtributoEstruturaLente(int id) {
        try (PreparedStatement preparedStatement = prepararSQL(DELETE_ATRIBUTO_ESTRUTURA_LENTE)) {
            preparedStatement.setInt(1, id);
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            printSQLException(e);
    ...
    public void updateAtributoEstruturaLente(AtributoEstruturaLente entity) {
        try (PreparedStatement preparedStatement = prepararSQL(UPDATE_ATRIBUTO_ESTRUTURA_LENTE)) {
            preparedStatement.setString(1, entity.getDescricao());
            preparedStatement.setString(2, entity.getLadoOlho());
